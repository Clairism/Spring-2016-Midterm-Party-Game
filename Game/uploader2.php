...
// process file upload
    ...
    if ($myFile["error"] !== UPLOAD_ERR_OK || $myFile2["error"] !== UPLOAD_ERR_OK  || $myFile3["error"] !== UPLOAD_ERR_OK  || $myFile4["error"] !== UPLOAD_ERR_OK ) 

        // || $myFile5["error"] !== UPLOAD_ERR_OK  || $myFile6["error"] !== UPLOAD_ERR_OK) 
{
        echo "<p>Go back and ensure 4 files are selected.</p>"; 
